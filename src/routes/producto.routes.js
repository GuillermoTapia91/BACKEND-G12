...
import * as ProductoController from "../controllers/producto.controllers.js";
...
// any() > acepta tanto archivos como textos, si hay varios archivos se almacenara en req.files
productoRouter
  .route("/productos")
  .post(middlewareMulter.single("imagen"), ProductoController.crearProducto);
productoRouter.get(
  "/devolver-imagen/:nombre",
  ProductoController.devolverImagenLocal
);
